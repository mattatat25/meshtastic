...
- [ReplyBotModule https://github.com/mattatat25/ReplyBotModule) - A lightweight Meshtastic firmware module that responds to simple text commands via direct messages.
